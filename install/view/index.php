...
<head>
    ...
    <meta name="author" content="avdbcms">
    <link rel="icon" href="../install/assets/images/favicon.ico" />
    <title>AVDBCMS - Live TV & Movie Portal CMS with Unlimited TV-Series Installation</title>
    ...
    <div class="install-box">
        ...
        <div class="panel panel-install">
            <div class="panel-heading text-center">
                <h2> AVDBCMS &amp; Video Steaming CMS Installation</h2>
            </div>
                            ...
                            <div class="section clearfix">
                                ...
                                <div>
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="" id="purchase_code" name="purchase_code"
                                                class="form-control"
                        ...
                        <div class="section">
                            <div class="clearfix">
                                <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span
                                    class="pull-left" style="line-height: 50px;">Congratulation! You have successfully
                                    installed <strong>AVDBCMS-Movie &amp; Video Steaming CMS</strong></span>
                            </div>
            ...
            $form.ajaxSubmit({
                ...
                success: function (result) {
                    ...
                    if (result.success) {
                        ...
                        $("#configuration").find("i").removeClass("fa-circle-o").addClass(
                            "fa-check-circle");
                        $("#finished").find("i").removeClass("fa-circle-o").addClass(
                            "fa-check-circle");
