...
class V130 extends RestController{ 
    ...
    public function slider_get() {
        ...
        if($response['slider_type'] == 'cubik'):
            $response['slider_type'] = 'movie';
            $response['data']           =   $this->api_v130_model->get_movies_for_slider();
        elseif($response['slider_type'] == 'image'):
    ...
    *****/
    ...
    public function latest_movies_get() {
        ...
        $response           =   $this->api_v130_model->get_latest_movies($limit);
        $this->response($response,200);
    }
    ...
    public function content_by_genre_id_get() {
        ...
        if(!empty($id) && $id !='' && $id !=NULL && is_numeric($id)):
            $validity           = $this->api_v130_model->verify_genre_id($id);
            if($validity):
                $page                   =   $this->input->get('page');
    ...
    public function content_by_country_id_get() {      
        $id                 =   $this->input->get('id');
        if(!empty($id) && $id !='' && $id !=NULL && is_numeric($id)):
            $validity           = $this->api_v130_model->verify_country_id($id);
            if($validity):
                $page                   =   $this->input->get('page');
    ...
    public function content_by_star_id_get() {
        $id                 =   $this->input->get('id');
        if(!empty($id) && $id !='' && $id !=NULL && is_numeric($id)):
            $validity           = $this->api_v130_model->verify_star_id($id);
            if($validity):
                $page                   =   $this->input->get('page');
    ...
    *****/
    ...
    public function latest_tvseries_get() {       
        $limit              =   $this->input->get('limit');
        $response           =   $this->api_v130_model->get_latest_tvseries($limit);
        $this->response($response,200);
    }
    ...
    *****/
    ...
    public function search_get() {
        ...
        if(strpos($type, "movie")!==false):
            $response['movie']              =   $this->api_v130_model->get_movie_search_result($q,$page,$genre_id,$country_id,$range_to,$range_from);
        endif;

        if(strpos($type, "series")!==false):
            $response['tvseries']              =   $this->api_v130_model->get_tvseries_search_result($q,$page,$genre_id,$country_id,$range_to,$range_from);
        endif;
