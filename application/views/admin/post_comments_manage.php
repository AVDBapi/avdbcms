    ...
    <div class="col-sm-12">
      <div class="btn-group dropdown pull-right">
        ...
        <ul class="dropdown-menu" role="menu">
          <li> <a href="<?php echo base_url() . 'admin/comments/post_comments/approved' ?>"><?php echo trans('approved'); ?></a></li>
          <li><a href="<?php echo base_url() . 'admin/comments/post_comments/unapproved' ?>"><?php echo trans('unapproved'); ?></a></li>
          <li><a href="<?php echo base_url() . 'admin/comments/post_comments/trash' ?>"><?php echo trans('trash'); ?></a></li>
          <li><a href="<?php echo base_url() . 'admin/comments/post_comments/spam' ?>"><?php echo trans('spam'); ?></a></li>
          <li><a href="<?php echo base_url() . 'admin/comments/post_comments/' ?>"><?php echo trans('all'); ?></a></li>
        </ul>
      </div>
      <br><br>
      <table id="datatable" class="table table-striped">
        ...
        <tbody>
          ...
          switch ($type) {
            case 'approved':
              $this->db->order_by('post_comments_id', 'DESC');
              $comments = $this->db->get_where('post_comments', array('publication' => '1'))->result_array();
              break;
            case 'unapproved':
              $this->db->order_by('post_comments_id', 'DESC');
              $comments = $this->db->get_where('post_comments', array('publication' => '0'))->result_array();
              break;
            case 'trash':
              $this->db->order_by('post_comments_id', 'DESC');
              $comments = $this->db->get_where('post_comments', array('publication' => '3'))->result_array();
              break;
            case 'spam':
              $this->db->order_by('post_comments_id', 'DESC');
              $comments = $this->db->get_where('post_comments', array('publication' => '2'))->result_array();
              break;
            default:
              $this->db->order_by('post_comments_id', 'DESC');
              $comments = $this->db->get('post_comments')->result_array();
              break;
          }
