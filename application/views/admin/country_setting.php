<?php $country_to_primary_menu           =   $this->db->get_where('config', array('title' => 'country_to_primary_menu'))->row()->value; ?>
<?php echo form_open(base_url() . 'admin/country_setting/update/', array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data')); ?>
<div class="card">
  <div class="row">
    <!-- panel  -->
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><?php echo trans('country_setting'); ?></h3>
        </div>
